...
void videocallback(IplImage *image)
{
    ...
    int edge_length = 7;
    int resolution = 5; // 5 is default
    double margin = 1; 
    marker_detector.SetMarkerSize(edge_length, resolution, margin); // for marker ids larger than 255, set the content resolution accordingly
